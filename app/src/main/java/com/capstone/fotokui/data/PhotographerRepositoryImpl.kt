...
class PhotographerRepositoryImpl @Inject constructor(
    ...
    override fun getPhotographer(photographerId: String): Flow<Response<Photographer>> = flow {
        ...
        try {
            ...
            val photographerExperience = photographerSnapshot.get("experience", Float::class.java) ?: 0F
            val photographerYearOrMonthExperience = photographerSnapshot.getString("yearOrMonthExperience")
            val photographerPrice = photographerSnapshot.get("price", Int::class.java) ?: 0
            val photographerPromo = photographerSnapshot.get("promo", Float::class.java) ?: 0F
            val photographerPhone = photographerSnapshot.getString("phone") ?: "0"
